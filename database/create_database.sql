...
ALTER TABLE orders
ADD COLUMN wilaya_id INT NOT NULL
AFTER shipping_zip;
ALTER TABLE orders
ADD CONSTRAINT fk_wilaya FOREIGN KEY (wilaya_id) REFERENCES wilayas(id);
...
-- Table pivot : Tailles disponibles pour chaque produit
