                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-8">
                  ...
                  <div className="mt-12 sm:mt-16 lg:mt-0">
                    <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                      <img
                        className="lg:w-[60%] w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none animate-zoom-in"
                        src={model}
                        alt="Qualité ESTILO"
                      />
                    </div>
